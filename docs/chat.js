(() => {
 ...
 host.innerHTML=`<button class="chat-launch" aria-expanded="false" aria-controls="chat-panel">✦ Ask about my work</button>
 <section id="chat-panel" aria-label="Website assistant" hidden><div class="chat-heading"><div><strong>Explore my work</strong><small>${endpoint?'AI assistant':'Website guide'}</small></div><button class="chat-close" aria-label="Close chat">×</button></div>
